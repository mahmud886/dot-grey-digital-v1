      ...
      schema: {
        services: fields.array(
          fields.object({
            ...
            deliverables: stringList("Deliverables", "Deliverable"),
            timeline: fields.array(
              fields.object({
                phase: text("Phase", "e.g. Week 1, Weeks 2-3"),
                title: text("Title"),
                body: multiline("Description"),
              }),
              { label: "Timeline", itemLabel: (item) => item.fields.phase.value || "Phase" },
            ),
            stat: fields.object({
              value: text("Value", "e.g. 8-12"),
              label: text("Label", "e.g. weeks, typical engagement"),
            }),
            faqs: fields.array(
              fields.object({ q: text("Question"), a: multiline("Answer") }),
              { label: "FAQs", itemLabel: (item) => item.fields.q.value || "Question" },
            ),
          }),
      ...
      schema: {
        ...
        works: fields.array(
          fields.object({
            ...
            team: text("Team size", "e.g. 2 people"),
            role: text("Our role"),
            tools: stringList("Tools", "Tool"),
            deliverables: stringList("Deliverables", "Deliverable"),
            approach: fields.array(
              fields.object({ title: text("Step title"), body: multiline("Description") }),
              { label: "Approach steps", itemLabel: (item) => item.fields.title.value || "Step" },
            ),
            outcome: multiline("Outcome"),
          }),
