...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        "grid size-10 shrink-0 place-items-center rounded-full border border-line text-fg transition-colors duration-300 hover:border-accent hover:text-accent",
        className,
      )}
    >
      <span className="transition-transform duration-400 [rotate:0deg] hover:[rotate:15deg]">
