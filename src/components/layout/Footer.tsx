  ...
  return (
    <footer className="relative overflow-hidden border-t border-line bg-bg-elev pt-20 md:pt-28">
      ...
      <div aria-hidden className="mt-16 overflow-hidden md:mt-24">
        <p className="px-5 text-center font-display leading-[0.78] font-extrabold tracking-[-0.04em] whitespace-nowrap text-fg/[0.06] uppercase [font-size:clamp(4rem,16vw,16rem)]">
          DotGrey
        </p>
      </div>
