  ...
  return (
    <form action={formAction} className="relative flex flex-col gap-7" noValidate>
      ...
      <div className="grid gap-7 sm:grid-cols-2">
        ...
        <Field name="email" label="Email" type="email" required error={errors.email} placeholder="jane@email.com" />
      </div>

      <div className="grid gap-7 sm:grid-cols-2">
        <Field name="phone" label="Phone" type="tel" error={errors.phone} placeholder="+880 1700 000000" />
        <Field name="portfolio" label="Portfolio or CV link" type="url" error={errors.portfolio} placeholder="https://" />
      </div>
